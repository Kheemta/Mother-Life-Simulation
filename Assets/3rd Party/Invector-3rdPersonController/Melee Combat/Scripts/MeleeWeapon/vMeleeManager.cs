...
namespace Invector.vMelee
{
    ...
    public class vMeleeManager : vMonoBehaviour, IWeaponEquipmentListener
    {
        ...
        IEnumerator MyDelay(Animator anim, float value)
        {
        ...
        public virtual void OnDamageHit(ref vHitInfo hitInfo)
        {
            ...
            //For Emerald Damage ...
            // if (hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>())
            // //if (hitInfo.targetCollider.gameObject.GetComponent<EmeraldAI.EmeraldAISystem>())
            // {
            //     // hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().Damage(hitInfo.attackObject.damage.damageValue, EmeraldAI.EmeraldAISystem.TargetType.Player, transform, 400);


            //     if (hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().IsDead)
            //     {
            ...
            //         if (hitInfo.targetCollider.gameObject.name == "Head")
            //         {
            //             //Invoke("Delay", 0.05f);
            //             Instantiate(HitEffect, hitInfo.hitPoint, transform.rotation);
            //             StartCoroutine(MyDelay(hitInfo.targetCollider.GetComponentInParent<Animator>(), 0.01f));
            //             Debug.Log(hitInfo.targetCollider.gameObject.name);
            //             hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().Damage(damage.damageValue, EmeraldAI.EmeraldAISystem.TargetType.Player);
            //             if (canPlay)
            //             {
                           
            //                 canPlay = false;
            //                 Debug.Log(4);
            //                 hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().gameObject.GetComponent<Animator>().SetInteger("Hit Index", 1);
            //             }
            //         }
            //         else if (hitInfo.targetCollider.gameObject.name == "Chest")
            //         {
            //             StartCoroutine(MyDelay(hitInfo.targetCollider.GetComponentInParent<Animator>(), 0.01f));
            //             //Invoke("Delay", 0.05f);
            //             Instantiate(HitEffect, hitInfo.hitPoint, transform.rotation);
            ...
            //                 Debug.Log(4);
            //                 canPlay = false;
            //                 hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().gameObject.GetComponent<Animator>().SetInteger("Hit Index", 2);
            //             }
            //         }
            //         else if (hitInfo.targetCollider.gameObject.name == "LeftLeg")
            //         {
            //             Instantiate(HitEffect, hitInfo.hitPoint, transform.rotation);
            //             StartCoroutine(MyDelay(hitInfo.targetCollider.GetComponentInParent<Animator>(), 0.01f));
            //             //Invoke("Delay", 0.05f);
            ...
            //                 Debug.Log(4);
            //                 canPlay = false;
            //                 hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().gameObject.GetComponent<Animator>().SetInteger("Hit Index", 3);
            //             }
            //         }
            //         else if (hitInfo.targetCollider.gameObject.name == "RightLeg")
            //         {
            //             Instantiate(HitEffect, hitInfo.hitPoint, transform.rotation);
            //             StartCoroutine(MyDelay(hitInfo.targetCollider.GetComponentInParent<Animator>(), 0.01f));
            //             //Invoke("Delay", 0.05f);
            ...
            //                 Debug.Log(4);
            //                 canPlay = false;
            //                 hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().gameObject.GetComponent<Animator>().SetInteger("Hit Index", 4);
            //             }
            //         }
            //         else if (hitInfo.targetCollider.gameObject.name == "LeftArm")
            //         {
            //             Instantiate(HitEffect, hitInfo.hitPoint, transform.rotation);
            //             StartCoroutine(MyDelay(hitInfo.targetCollider.GetComponentInParent<Animator>(), 0.01f));
            //             //Invoke("Delay", 0.05f);
            ...
            //                 Debug.Log(4);
            //                 canPlay = false;
            //                 hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().gameObject.GetComponent<Animator>().SetInteger("Hit Index", 5);
            //             }
            //         }
            //         else if (hitInfo.targetCollider.gameObject.name == "RightArm")
            //         {
            //             Instantiate(HitEffect, hitInfo.hitPoint, transform.rotation);
            //             StartCoroutine(MyDelay(hitInfo.targetCollider.GetComponentInParent<Animator>(), 0.01f));
            //             Debug.Log(hitInfo.targetCollider.gameObject.name);
            ...
            //                 Debug.Log(4);
            //                 canPlay = false;
            //                 hitInfo.targetCollider.gameObject.GetComponentInParent<EmeraldAI.EmeraldAISystem>().gameObject.GetComponent<Animator>().SetInteger("Hit Index", 6);
            //             }
            //         }
